...
# charges for 010101
your_charge_list = [
    1.3793, 1.2067, 1.3793, 1.2338, 1.4762, 1.2338,
    0.1963, -0.1353, 0.1963, -0.0179, 0.3571, -0.0179,
    -0.4746, -0.2896, -0.4746, -0.4063, -0.5115, -0.4063,
    -1.0151, -1.0151, -1.0151, -0.8687, -0.8017, -0.8687,
    -1.0151, -1.0151, -1.0151, -0.8843, -0.7802, -0.8843,
    -1.0511, -1.0511, -1.0511, -0.8843, -0.7802, -0.8843,
    0.0805, 0.2086, 0.0805, 0.1409, 0.1392, 0.1409,
    0.3832, 0.3832, 0.3988
]
...
if n_atoms != len(your_charge_list):
    raise ValueError(f"Charge list has {len(your_charge_list)} values, "
