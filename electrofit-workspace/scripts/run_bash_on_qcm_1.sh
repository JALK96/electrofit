...
BASH_SCRIPT="/home/johannal96/PhD.nobackup/electrofit/electrofit-workspace/tests/integration/run_all_1.sh"
...
source ~/.bashrc && \
screen -dmS \"$SCREEN_SESSION\" bash -c \"conda activate AmberTools23; bash '$BASH_SCRIPT'; exec bash\""
...
log "Successfully started YOUR_PYTHON_SCRIPT in Screen session '$SCREEN_SESSION' on $REMOTE_HOST in conda environment AmberTools23."
