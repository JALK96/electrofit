...
class neqFEP:
    ...
    def boxWaterIons(self, edges=None, bBox=True, bSolvate=True, bIon=True):
        ...
        for edge in edges:
            ...
            # Define box
            if bBox:
                print(f"Call editconf to set up the box, with parameter: boxshape = {self.boxshape}, d = {self.boxd}")
    ...
    def _prepare_single_tpr(self, simpath, toppath, state, simType, empath=None, frameNum=0):
        ...
        print(f"Running grompp to prepare tpr from structure: {inStruct} using topology: {topFile} and mdp: {mdpFile}")
