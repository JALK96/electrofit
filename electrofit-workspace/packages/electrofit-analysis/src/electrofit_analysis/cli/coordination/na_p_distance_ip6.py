...
def plot_all_distances_subplots(
    output_prefix, num_groups, plot_filename="all_distances_subplots.png"
):
    # Delegate to shared utility while preserving PNG default here
    from electrofit_analysis.structure.util.common_gmx import plot_all_distances_subplots as _plot
