...
def run_pairdist_commands(
    ...
    for i, group in enumerate(groups, start=1):
        ...
        logging.info(
            f"Running gmx pairdist for group '{group}' and outputting to '{output_file}'..."
        )
...
def plot_all_distances_subplots(
    ...
    for i in range(1, num_groups + 1):
        ...
        try:
            ...
            ax.plot(
                time, distance, color="black", linestyle="-", linewidth=0.5, marker=None
            )
    ...
    fig.suptitle(
        "Minimum Distances Between Phosphorus Groups and Na-Ions", fontsize=18, y=1.05
    )
