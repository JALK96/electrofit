...
def plot_single_subdir_set(
    base_dir, energy_term=10, invert_y=False, ax=None, title="", units="kJ"
):
    """
...
def main():
    ...
    parser.add_argument(
        "base_dir1", type=str, help="First base directory with lambda_* subdirectories."
    )
    parser.add_argument(
        "base_dir2",
        nargs="?",
    ...
    plot_energy_density_vertical(
        args.base_dir1, args.base_dir2, energy_term=args.energy_term, units=args.units
    )
