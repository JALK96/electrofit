            ...
            if os.path.isdir(folder_path):
                ...
                if os.path.isdir(run_final_sim_dir):
                    ...
                    if len(carbon_data) > 0:
                        fig_carbon, ax_carbon = plt.subplots(figsize=(7, 5), constrained_layout=True)
                    ...
                    if len(oxygen_data) > 0:
                        ...
                        for chunk_idx, chunk_data in enumerate(oxygen_chunks):
                            fig_oxy, ax_oxy = plt.subplots(figsize=(7, 5), constrained_layout=True)
                    ...
                    if len(oxygen_data) > 0:
                        ...
                        fig_summary, ax_summary = plt.subplots(figsize=(7, 5), constrained_layout=True)
