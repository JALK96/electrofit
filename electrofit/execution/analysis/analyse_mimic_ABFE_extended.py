...
# =============================================================================
# Input directory containing simulation output files (change to your actual path)
dir_input = "/home/johannal96/MA/electrofit/FEP/equilibrium-FEP/011111-111101_analysis/edges/edge_011111_111101/water/stateB/run1/transitions"

# Output directory where images and summary will be saved
dir_output = "/home/johannal96/MA/electrofit/FEP/equilibrium-FEP/011111-111101_analysis/edges/edge_011111_111101/water/analyse_r1_test/stateB"
...
energy_units = 'kcal/mol'  # Units for reporting free energies

# File name matching parameters
prefix_pattern = 'dhdl'    # The file prefix (identifies the type of data file)
suffix_pattern = 'xvg'     # The file suffix (extension)

# Options for analysis and plotting
skiptime = 300             # Time to skip as equilibration (units as in simulation output)
uncorr = 'dhdl'            # Observable used for autocorrelation (here using dHdl)
threshold = 50             # Minimum number of decorrelated samples required
estimators_to_use = ("MBAR", "BAR", "TI")  # Free energy estimators to run
...
# Build a recursive glob pattern for files: **/prefix*{suffix}
...
# =============================================================================
# 5. Select the parser functions based on simulation software
# =============================================================================
# (For this example we assume 'GROMACS'; change to 'AMBER' or 'PARQUET' as necessary.)
_extract_u_nk = gmx.extract_u_nk
_extract_dHdl = gmx.extract_dHdl

# =============================================================================
# 6. Define functions to read data from each file using parallel processing
# =============================================================================
def read_u_nk(file, T):
    """Extract u_nk from a single file."""
    try:
...
def read_dHdl(file, T):
    """Extract dHdl from a single file."""
    try:
...
# Read u_nk and dHdl from all files in parallel.
...
# Processed (decorrelated) data: lists for u_nk and dHdl
u_nk_sample_list = []  
if u_nk_list:
...
# =============================================================================
# 9. Concatenate the data for estimation
# =============================================================================
# For decorrelated (uncorrelated) data:
if u_nk_sample_list:
...
# For raw (correlated) data, concatenate directly from the original lists:
...
# =============================================================================
# Run estimators for decorrelated data:
estimators_results = {}
...
# Log the lambda values for each state (decorrelated)
...
# Log the lambda values for each state (raw)
...
# =============================================================================
# 11. Generate a summary DataFrame of free energy results for decorrelated data
# =============================================================================
...
# Add atributes back to the DataFrame
...
# 12c. Free energy state differences plot
...
# =============================================================================
# 13. Repeat: Generate summary and plots for raw (correlated) data
# =============================================================================
# 13a. Generate summary DataFrame for raw data (similar to Step 11)
...
# 13b. Generate diagnostic plots for raw data
...
# Convergence analysis for raw data:
if "MBAR" in estimators_results_raw:
