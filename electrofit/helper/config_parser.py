        ...
        with open(self.filepath, 'r') as file:
            for line_num, line in enumerate(file, start=1):
                ...
                if ':' in stripped_line:
                    ...
                    print(f"Warning: Line {line_num} in '{self.filepath}' is not a valid key-value pair and will be ignored.")
    ...
    def _assign_parameter(self, key, value, line_num):
        ...
        if key_lower in key_map:
            ...
            try:
                ...
                raise ValueError(f"Invalid value for '{key}' on line {line_num}: '{value}'. Expected type {self._expected_type(actual_key).__name__}.") from ve
        else:
            print(f"Warning: Unknown parameter '{key}' on line {line_num}. It will be ignored.")
