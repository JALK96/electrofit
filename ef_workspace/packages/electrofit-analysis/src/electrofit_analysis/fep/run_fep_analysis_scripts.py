...
analysis_scripts = [
    "/home/johannal96/MA/electrofit/electrofit/execution/analysis/plot_dU_distributions_vertical.py __A__ __B__ --skip-time 1000 --units kcal",
]
...
def run_analysis_in_directory(analysis_dir: Path, stateA_path: Path, stateB_path: Path):
    ...
    for script in analysis_scripts:
        if "__A__" in script and "__B__" in script:
            ...
            print(
                f"      -> Script has unknown placeholders (neither __A__ nor __B__ nor __D__ nor __O__): {script}"
            )
